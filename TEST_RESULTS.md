...
```
$ forge test
Ran 9 test suites: 157 tests passed, 0 failed, 1 skipped (158 total tests)
```
...
AgentDesk         17,231   (optional real spot desk — firm-funded; reads PropFund via the lens; bracket orders + allocation ladder + ERC-3156 flash lending)
```
