...
```
$ forge test
Ran 9 test suites: 161 tests passed, 0 failed, 1 skipped (162 total tests)
```
...
AgentDesk         18,969   (optional real spot desk — firm-funded; reads PropFund via the lens; bracket orders + allocation ladder + ERC-3156 flash lending incl. oracle-fresh loans)
```
