...
```
$ forge test
Ran 9 test suites: 150 tests passed, 0 failed, 1 skipped (151 total tests)
```
...
AgentDesk         15,862   (optional real spot desk — firm-funded; reads PropFund via the lens; bracket orders + allocation ladder)
```
