...
```
$ forge test
Ran 9 test suites: 141 tests passed, 0 failed, 1 skipped (142 total tests)
```
...
AgentDesk         13,137   (optional real spot desk — firm-funded; reads PropFund via the lens; allocation ladder)
```
